...
" See also: https://vim.fandom.com/wiki/Faster_loading_of_large_files
fun! local#buffer#large(name)
...
fun! local#buffer#delete_others()
...
fun! local#buffer#clear(file_pattern)
...
fun! local#buffer#swap_exists(file)
